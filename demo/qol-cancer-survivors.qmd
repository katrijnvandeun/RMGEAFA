...
Concatenate data of the different tumor groups:
...
Crude view: PVE for concatenated data (suggests 1 dimension).
...
Larger number of factors (4 instead of 2) suggests heterogeneity over groups.
...
modelsel$lambda <- 0.005 # other solution introduces close to zero loadings in multistart
```
...
Variability loadings over groups -\> constipation, diarrhea, cogn.funct. and appetite loss:
