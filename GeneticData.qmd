...
```{r}
diagnosis <- c("SZ","SZ","SZ","SZA","SZA","SZA","SZ","SZ","SZA","SZA","SZA",
...
patientid<-c("phchp003","phchp003","phchp003","phchp004","phchp004","phchp004","phchp009","phchp009","phchp010","phchp010",
...
source("../CoreFunctions/multistart.R")
source("../CoreFunctions/PSTR.R")
source("../CoreFunctions/JointSPCA_finalizing.R") ##needs matlib??
...
save(CONSENSUS, file = "consenses_genetic.RData")
...
save(FA1,FA2,FA3,file="loadings_genetic.RData")
```
...
```{r}
load("consenses_genetic.RData")
load("loadings_genetic.RData")
...
Create confusion matrix ... or compare mood to non-mood disorders ... mds plot?
