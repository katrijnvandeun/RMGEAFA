...
for (i in 1:length(n)){
  ...
  result13 <- as.data.frame(t(replicate(50,getValue())))
  result13$size <- c(rep(n[i],50))
  result13$nrpcs <- 4
  result13$nrgroups <- 2
  final_result13 <- rbind(final_result13,result13)
}

#colnames(final_result13) <- c("Recovery","Tucker","Group_size")
save(final_result13, file = "final_result13v2.Rda")
