...
result15 <- as.data.frame(t(replicate(50,getValue())))
result15$size <- c(rep(n[i],50))
result15$nrpcs <- 4
result15$nrgroups <- 2
final_result15 <- rbind(final_result15,result15)
}

#colnames(final_result15) <- c("Recovery","Tucker","Group_size")
save(final_result15, file = "final_result15v2.Rda")
