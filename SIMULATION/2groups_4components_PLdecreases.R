...
result17 <- as.data.frame(t(replicate(50,getValue())))
result17$size <- c(rep(n[i],50))
result17$nrpcs <- 4
result17$nrgroups <- 2
final_result17 <- rbind(final_result17,result17)
}

#colnames(final_result17) <- c("Recovery","Tucker","Group_size")
save(final_result17, file = "final_result17v2.Rda")
