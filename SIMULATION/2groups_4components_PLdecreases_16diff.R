...
result19 <- as.data.frame(t(replicate(50,getValue())))
result19$size <- c(rep(n[i],50))
result19$nrpcs <- 4
result19$nrgroups <- 2
final_result19 <- rbind(final_result19,result19)
}

#colnames(final_result19) <- c("Recovery","Tucker","Group_size")
save(final_result19, file = "final_result19v2.Rda")
