...
for (i in 1:length(n)){
  ...
  result34 <- as.data.frame(t(replicate(50,getValue())))
  result34$size <- c(rep(n[i],50))
  result34$nrpcs <- 4
  result34$nrgroups <- 4
  final_result34 <- rbind(final_result34,result34)
}

#colnames(final_result34) <- c("Recovery","Tucker","Group_size")
save(final_result34, file = "final_result34v2.Rda")
